...
download_fnm() {
  if [ "$USE_HOMEBREW" = "true" ]; then
    ...
    if [ "$RELEASE" = "latest" ]; then
      URL="https://proxy.vercel.lihaha.cn/proxy/github.com/Schniz/fnm/releases/latest/download/$FILENAME.zip"
    else
      URL="https://proxy.vercel.lihaha.cn/proxy/github.com/Schniz/fnm/releases/download/$RELEASE/$FILENAME.zip"
    fi
